...
define('DSN', 'mysql:host=192.168.20.19;dbname=DB214DWESProyectoTema4'); // Host 'IP' y nombre de la base de datos
define('USERNAME','user214DWESProyectoTema4'); // Nombre de usuario de la base de datos
define('PASSWORD','paso'); // Contraseña de la base de datostrtrtr
*/
/**
 * @author Carlos García Cachón
 * @version 1.0 
