<!DOCTYPE html>
<!--
	Descripción: CodigoScriptBorrar
...
<head>
  ...
  <meta name="description" content="CodigoCargaBorrar">
  <meta name="keywords" content="CodigoCargaBorrar">
    ...
    <main>
        <div class="container justify-content-start">
            <?php
                ...
                highlight_file('../scriptDB/BorraDAW214DBDepartamentos.php');
            ?>
        </div>
    </main>
