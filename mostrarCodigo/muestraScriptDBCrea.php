...
<head>
  ...
  <meta name="description" content="CodigoScriptCrea">
  <meta name="keywords" content="CodigoScriptCrea">
    ...
    <main>
        <div class="container justify-content-start">
            <?php
                ...
                highlight_file('../scriptDB/CreaDAW214DBDepartamentos.php');
            ?>
        </div>
    </main>
