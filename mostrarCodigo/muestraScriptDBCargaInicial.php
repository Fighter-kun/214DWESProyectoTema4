<!DOCTYPE html>
<!--
	Descripción: CodigoScriptCargaInicial
...
<head>
  ...
  <meta name="description" content="CodigoCargaInicial">
  <meta name="keywords" content="CodigoCargaInicial">
    ...
    <main>
        <div class="container justify-content-start">
            <?php
                ...
                highlight_file('../scriptDB/CargaInicialDAW214DBDepartamentos.php');
            ?>
        </div>
    </main>
